const T = {
  ...
  F: {
    ...
    NOTION: {
      FORM: {
        API_TOKEN: 'F.NOTION.FORM.API_TOKEN',
        DATABASE_ID: 'F.NOTION.FORM.DATABASE_ID',
        DATABASE_ID_DESCRIPTION: 'F.NOTION.FORM.DATABASE_ID_DESCRIPTION',
        TITLE_PROPERTY_NAME: 'F.NOTION.FORM.TITLE_PROPERTY_NAME',
        STATUS_PROPERTY_NAME: 'F.NOTION.FORM.STATUS_PROPERTY_NAME',
        DONE_STATUS_NAME: 'F.NOTION.FORM.DONE_STATUS_NAME',
        ASSIGNEE_PROPERTY_NAME: 'F.NOTION.FORM.ASSIGNEE_PROPERTY_NAME',
      },
      FORM_SECTION: {
        HELP: 'F.NOTION.FORM_SECTION.HELP',
      },
    },
    GITLAB: {
